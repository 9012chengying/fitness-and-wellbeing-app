...
public class WorkoutRepositoryJDBC implements WorkoutRepository {
    ...
    public WorkoutSummaryDTO workoutDetailsByWorkoutID(int workoutID) {
    ...
    /*public WorkoutSummaryDTO incompleteWorkout(int clientID) {
        WorkoutSummaryDTO workoutSummaryDTO = (WorkoutSummaryDTO) jdbcTemplate.query(
                "SELECT id FROM Workouts WHERE client_id=? AND completed=false ORDER BY created_at LIMIT 1",
                new WorkoutSummaryMapper(), clientID);
            return workoutSummaryDTO;
    }*/
